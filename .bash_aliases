...
alias update="sudo rustup update && sudo pacman -Syu; paru -Syu"
...
alias ghaupdate="Rscript -e 'usethis::use_github_action(\"test-coverage\",); usethis::use_github_action(\"check-standard\")'"
