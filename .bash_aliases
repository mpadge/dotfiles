...
alias update="bash <path>/<to>/update.bash"
alias updateable="paru -Qu"
alias ghaupdate="bash <path>/<to>/r-lib-actions.bash"
...
alias cb="gn codeberg"
alias commits="gn commits"
...
alias workflow-checks='bash /<path/<to>/gha-workflows.bash'
alias find-remote='bash /<path/<to>/find-remotes.sh'
